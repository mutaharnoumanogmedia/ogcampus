    ...
    this.IQUtils.getColorShadeTint = (color, value) => {
        ...
        style.innerHTML = `
            [data-bs-theme-color="custom"] {
                ...
                ${color}-shade-90: ${IQUtils.shadeColor(value, 90)};
                ...
                ${color}-tint-90: ${IQUtils.shadeColor(value, 90)};
                ${color}-tint-80: ${IQUtils.shadeColor(value, 80)};
                ${color}-tint-60: ${IQUtils.shadeColor(value, 60)};
                ${color}-tint-40: ${IQUtils.shadeColor(value, 40)};
                ${color}-tint-20: ${IQUtils.shadeColor(value, 20)};
                ${color}-tint-10: ${IQUtils.shadeColor(value, 10)};
            }
